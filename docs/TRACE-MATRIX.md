...
| L2-PAY-004 | L3-PAY-010, L3-PAY-011, L3-PAY-012 | `docs/AS5643.md`<br>`docs/PAYLOADS.md`<br>`docs/adr/0012-use-built-in-rust-payload-definitions.md` | Partially Implemented |
